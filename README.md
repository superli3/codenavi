...
For the classification portion of this project, I used a seq2seq classification model. 
...
## 4) Parse abstract syntax tree into word sequences

## 5) Run Language Model on parsed abstract syntax tree
...
Happy to hear it - please feel free to drop a line in the issues section, or 
